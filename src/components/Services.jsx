...
const services = [
  {
    ...
    features: ['Menu & gallery sections', 'Online reservation form', 'Mouth-watering visual design']
  },
  {
    title: 'Gym Website',
    icon: Dumbbell,
    gradient: 'from-emerald-500 to-teal-500',
    features: ['Trainer & class listings', 'Membership plan cards', 'High-energy, motivating design']
  },
  {
    title: 'Hotel Website',
    icon: Hotel,
  ...
  },
  {
    ...
    features: ['Focused single-page layout', 'Strong call-to-action design', 'Fast load & mobile-first']
  }
];
  ...
  return (
    <section id="services" className="section-spacing section-container scroll-mt-24">
      <SectionHeading
        ...
        description="Specialized web design and development solutions tailored for small businesses that want to stand out online."
        centered
      />
        ...
        {services.map((service, index) => {
          ...
          return (
            <div
              ...
              className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-soft transition-all duration-300 hover:-translate-y-2 hover:border-brand-300 hover:shadow-card"
            >
      ...
      >
        ...
        <a href="#contact" className="btn-accent btn-magnetic mt-5 inline-flex items-center gap-2">
